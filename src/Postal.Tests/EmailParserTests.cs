...
//            using (var message = parser.Parse(input, new Template("Test")))
//            {
...
//            var email = new Template("~/Views/Emails/Test.cshtml");
//            var renderer = new Mock<ITemplateViewRenderer>();
...
//            var parser = new EmailParser(Mock.Of<ITemplateViewRenderer>());
...
//            var parser = new EmailParser(Mock.Of<ITemplateViewRenderer>());
//            using (var message = parser.Parse("body", (Template)email))
//            {
...
//            dynamic email = new Template("Test");
//            email.To = "test@test.com";
//            using (var message = parser.Parse(input, (Template)email))
//            {
//                // Check for bug reported here: http://aboutcode.net/2010/11/17/going-postal-generating-email-with-aspnet-mvc-view-engines.html#comment-153486994
//                // Should not add anything extra to the 'To' list.
//                message.To.Count.ShouldEqual(1);
